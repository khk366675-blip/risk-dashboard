...
import './globals.css';
import { CollectionJobs } from '@/components/collection-jobs';
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ko"><body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>{children}<CollectionJobs /></body></html>;
}
